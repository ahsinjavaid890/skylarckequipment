...
<div id="content-wrapper">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <table id="dataTable" class="table table-bordered">
                      ...
                      <tbody>
                        <?php foreach(DB::table('siteurls')->get() as $r){ ?>
                        <tr>
                            <td>{{$r->url}}</td>
                            <td>{{$r->modalname}}</td>
                            <td style="text-align: center;">
                              <button onclick="editurl({{ $r->ID }})" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></button>
                            </td>
                        </tr>
                        <?php }  ?>
                      </tbody>
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('updatsiteurl') }}">
                            {{ csrf_field() }}
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="modelname" name="modal">
                          </div>
                          <div class="form-group">
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                        <form method="post" action="{{ url('updatemetatagsenglish') }}" enctype="multipart/form-data">
                          ...
                          <input type="hidden" value="siteurls" name="modalname">
                          <h3></h3>
                          <div class="form-group">
    ...
    <script type="text/javascript">
      function editurl(id)
      {
        $.ajax({
          type:'GET',
          url:"{{ url('admin/editurl') }}/"+id,
          datatype:'json',
          success: function(res)
          {
            $("#siteurl").val(res.url);
            $("#modelname").val(res.modalname);
