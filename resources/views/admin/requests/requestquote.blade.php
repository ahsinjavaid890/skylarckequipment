...
<div id="content-wrapper">
              ...
              <div class="card">
                ...
                <div class="card-body">
                    <table id="dataTable" class="table table-bordered">
                      ...
                      <tbody>
                        <?php foreach(DB::table('bigdealsoffers')->orderBy('id')->get() as $r){ ?>
                        <tr>
                            <td>{{$r->name}}</td>
                            <td>{{$r->email}}</td>
                            <td>{{$r->phonenumber}}</td>
                            ...
                            <td class="text-center"> 
                              <a onclick="viewbigdeal({{ $r->id }})" href="{{ url('viewfundingrequestoffer/') }}/{{ $r->id }}">
    ...
    <script type="text/javascript">
      function viewbigdeal(id)
      {
        $.ajax({
          type:'GET',
          url:"{{ url('changestatus') }}/"+id+"/bigdealsoffers",
