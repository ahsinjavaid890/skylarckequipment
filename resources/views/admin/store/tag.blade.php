            ...
            <div class="card-header card-success">
                <div class="row">
                  ...
                  <div style="text-align: right;" class="col-md-6">
                      <button class="btn btn-primary" data-toggle="modal" data-target="#addcategory">Add Store Tag</button>
                  </div>
                </div>
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                          <button onclick="editstoretag({{ $r->id }})" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></button>
                        </td>
                    </tr>
                    <?php }  ?>
                  </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Add Store Category</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
          <form method="POST" action="{{ url('createstoretags') }}">
              {{ csrf_field() }}
...
<div class="modal fade" id="myModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Update Store Tag</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <!-- Modal body -->
      <div class="modal-body">
        <div class="row">
          <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('updatestoretag') }}">
                        {{ csrf_field() }}
                      ...
                      <div class="form-group">
                        <input type="submit" value="Update Store Tag" class="btn btn-primary">
                      </div>
                    </form>
                </div>
            </div>
              ...
              <div class="card">
                  ...
                  <div class="card-body">
                    <form method="post" action="{{ url('updatemetatagsenglish') }}" enctype="multipart/form-data">
                      ...
                      <input type="hidden" value="storetags" name="modalname">
                      <h3></h3>
                      <div class="form-group">
...
<script type="text/javascript">
  function editstoretag(id)
  {
    $.ajax({
      type:'GET',
      url:"{{ url('getstoretag') }}/"+id,
      datatype:'json',
