                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                              <button onclick="editblogcategory({{ $r->id }})" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></button>
                            </td>
                        </tr>
                        <?php }  ?>
                      </tbody>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form method="POST" action="{{ url('createblogcategory') }}">
                  {{ csrf_field() }}
            ...
            <div class="row">
              <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('updateblogcategory') }}">
                            {{ csrf_field() }}
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                        <form method="post" action="{{ url('updatemetatagsenglish') }}" enctype="multipart/form-data">
                          ...
                          <input type="hidden" value="blogcategories" name="modalname">
                          <h3></h3>
                          <div class="form-group">
